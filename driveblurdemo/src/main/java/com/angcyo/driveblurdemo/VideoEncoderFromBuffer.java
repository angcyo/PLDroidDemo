...
public class VideoEncoderFromBuffer {
    ...
    private static int BIT_RATE;// = CameraWrapper.IMAGE_HEIGHT * CameraWrapper.IMAGE_WIDTH * 3 * 8 * FRAME_RATE / COMPRESS_RATIO; // bit rate CameraWrapper.
    byte[] mFrameData;
    ...
    public VideoEncoderFromBuffer(int width, int height) {
        ...
        //robi
        BIT_RATE = this.mWidth * this.mHeight * 3 * 8 * FRAME_RATE / COMPRESS_RATIO;

//        mFrameData = new byte[this.mWidth * this.mHeight];
